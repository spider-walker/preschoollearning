...
export class UsersViewPage {
    ...
    constructor(public navCtrl: NavController,
        ...
        my_this.childrens = [];
        this.childrenProvider.getParentChildrens(this.parent_id).subscribe(snapshots => {
            snapshots.forEach(snapshot => {
                 snapshot.immunization=[];
                my_this.immunizationProvider.getParentImmunizations(snapshot.child_id).subscribe(snapshots_im => {
