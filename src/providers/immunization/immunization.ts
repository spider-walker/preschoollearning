...
export class ImmunizationProvider {
    ...
    constructor(public afs: AngularFirestore) {
        this.dbimmunizationCollection = afs.collection<Immunization>('dbimmunization');
        this.dbimmunization = this.dbimmunizationCollection.valueChanges();
    }

    getImmunizations() {
        this.dbimmunizationCollection = this.afs.collection<Immunization>('dbimmunization');
        this.dbimmunization = this.dbimmunizationCollection.valueChanges();
        return this.dbimmunization;
    }
    getParentImmunizations(child_id: number) {
        this.dbimmunizationCollection = this.afs.collection<Immunization>('dbimmunization', ref => ref.where('child_id', '==', child_id));
        this.dbimmunization = this.dbimmunizationCollection.valueChanges();
        return this.dbimmunization;
    }
